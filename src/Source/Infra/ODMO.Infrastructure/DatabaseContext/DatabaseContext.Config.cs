...
using ODMO.Infrastructure.ContextConfiguration.Config.Events;
using Microsoft.EntityFrameworkCore;
using BitsDropRewardConfigConfiguration =
    ODMO.Infrastructure.ContextConfiguration.Config.BitsDropRewardConfigConfiguration;
using ItemDropRewardConfigConfiguration =
    ODMO.Infrastructure.ContextConfiguration.Config.ItemDropRewardConfigConfiguration;
