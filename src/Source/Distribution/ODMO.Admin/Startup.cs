...
using ODMO.Commons.ViewModel.Login;
...
namespace ODMO.Admin
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<ODMO.Admin.Services.IDownloadService, ODMO.Admin.Services.DownloadService>();
            services.AddScoped<ODMO.Admin.Services.IAuditService, ODMO.Admin.Services.AuditService>();
